...
//        userDTO1.setFirstName("John Doe");
//
//        when(userRepository.findById(user1.getId())).thenReturn(Optional.of(user1));
//        when(userMapper.userToUserDTO(user1)).thenReturn(userDTO1);
//
//        // When
//        Optional<UserDTO> user = Optional.ofNullable(userService.get(user1.getId()));
//
//        // Then
...
//
//        // When
//        Optional<UserDTO> user = Optional.ofNullable(userService.get(userId));
//
//        // Then
...
//        userDTO2.setFirstName("Jane Doe");
//
...
//        assertThat(userDTOs.get(0).getFirstName()).isEqualTo("John Doe");
//        assertThat(userDTOs.get(1).getFirstName()).isEqualTo("Jane Doe");
//    }
//}
